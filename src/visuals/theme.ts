...
export const theme = {
  ...
  friendTones: [
    { core: [0.92, 0.9, 0.84], glow: [0.76, 0.68, 0.56], rim: [1.0, 0.96, 0.86] },
    { core: [0.86, 0.9, 0.88], glow: [0.52, 0.66, 0.62], rim: [0.92, 1.0, 0.96] },
    { core: [0.92, 0.86, 0.8], glow: [0.66, 0.54, 0.46], rim: [1.0, 0.92, 0.84] },
    { core: [0.86, 0.88, 0.94], glow: [0.5, 0.56, 0.68], rim: [0.92, 0.96, 1.0] },
  ] as OrbTone[],
  youTone: {
    core: [0.98, 0.98, 0.94],
    glow: [0.72, 0.76, 0.72],
